...
let dot = '<svg width="21" height="5" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Zm8 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5Z" fill="#BBC0FF" fill-rule="evenodd"/></svg>';
...
let card = document.querySelector('.tracking');
...
function display() {
     ...
     let d = data.map((e) => {
          ...
          <div class="front">
            ...
            <div class="hrs">
              <h1>${e.timeframes.daily.current} hrs</h1>
              <span>Last Week - ${e.timeframes.daily.previous} hrs</span>
            </div>
          </div>
        </section>
          `
          ...
          <div class="front">
            <div class="menu">
              ...
              ${dot}
               ...
               <h1>${e.timeframes.weekly.current} hrs</h1>
            <span>Last Week - ${e.timeframes.weekly.previous} hrs</span>
          </div>
        </section>
          `
     })
          ...
          <div class="front">
            <div class="menu">
              ...
              ${dot}
               ...
               <h1>${e.timeframes.monthly.current} hrs</h1>
            <span>Last Week - ${e.timeframes.monthly.previous} hrs</span>
          </div>
        </section>`
     })
     card.innerHTML = d.join('');
